...
COPY ./terraform /home/ubuntu/data-projects/di-aws-emr-with-apache-flink/terraform
RUN chown -R ubuntu:ubuntu /home/ubuntu/data-projects/di-aws-emr-with-apache-flink/terraform

# Switch to ubuntu user
USER ubuntu

# Set the working directory
WORKDIR /home/ubuntu/data-projects/di-aws-emr-with-apache-flink/terraform
